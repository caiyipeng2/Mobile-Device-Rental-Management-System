...
namespace DeviceRental.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260903103214_NotificationDeliveryAndOperationalIndexes")]
    partial class NotificationDeliveryAndOperationalIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeviceRental.Infrastructure.Persistence.Records.DeviceImageMetadataRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("Sha256Hex")
                        .HasDatabaseName("ix_device_images_sha256");

                    b.HasIndex("StorageKey")
                        .IsUnique()
                        .HasDatabaseName("ux_device_images_storage_key");

                    b.ToTable("device_images", "device_rental", t =>
                        {
                            t.HasCheckConstraint("ck_device_images_content_type", "content_type IN ('image/jpeg', 'image/png', 'image/webp')");

                            t.HasCheckConstraint("ck_device_images_dimensions", "byte_length > 0 AND byte_length <= 5242880 AND pixel_width > 0 AND pixel_height > 0 AND pixel_width <= 4096 AND pixel_height <= 4096 AND (pixel_width::bigint * pixel_height::bigint) <= 16000000");

                            t.HasCheckConstraint("ck_device_images_id_nonzero", "id <> '00000000-0000-0000-0000-000000000000'::uuid");

                            t.HasCheckConstraint("ck_device_images_sha256", "sha256_hex ~ '^[0-9a-f]{64}$'");

                            t.HasCheckConstraint("ck_device_images_storage_key", "storage_key LIKE 'images/%' AND btrim(storage_key) <> ''");
                        });
                });
            ...
            modelBuilder.Entity("DeviceRental.Infrastructure.Persistence.Records.LoanPolicyVersionRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("EffectiveAtUtc", "VersionNumber")
                        .HasDatabaseName("ix_loan_policy_versions_effective");

                    b.ToTable("loan_policy_versions", "device_rental", t =>
                        {
                            t.HasCheckConstraint("ck_loan_policy_versions_actor_nonzero", "changed_by_user_id <> '00000000-0000-0000-0000-000000000000'::uuid");

                            t.HasCheckConstraint("ck_loan_policy_versions_duration", "duration_minutes BETWEEN 60 AND 10080");

                            t.HasCheckConstraint("ck_loan_policy_versions_id_nonzero", "id <> '00000000-0000-0000-0000-000000000000'::uuid");

                            t.HasCheckConstraint("ck_loan_policy_versions_reason", "btrim(reason) <> ''");

                            t.HasCheckConstraint("ck_loan_policy_versions_version_positive", "version_number > 0");
                        });
                });
            ...
            modelBuilder.Entity("DeviceRental.Infrastructure.Persistence.Records.NotificationDeliveryRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("AcceptanceEvidence")
                        .IsRequired()
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)")
                        .HasColumnName("acceptance_evidence");

                    b.Property<string>("AcceptanceEvidenceReference")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)")
                        .HasColumnName("acceptance_evidence_reference");
                    ...
                    b.Property<string>("RecipientKeyVersion")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                    ...
                    b.Property<string>("TemplateIdentifier")
                        ...
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                        .HasColumnName("template_identifier");
                    ...
                    b.HasIndex("EventId", "DedupeKey")
                        .IsUnique()
                        .HasDatabaseName("ux_notification_deliveries_event_dedupe");

                    b.ToTable("notification_deliveries", "device_rental", t =>
                        {
                            t.HasCheckConstraint("ck_notification_deliveries_event_nonzero", "event_id <> '00000000-0000-0000-0000-000000000000'::uuid");

                            t.HasCheckConstraint("ck_notification_deliveries_id_nonzero", "id <> '00000000-0000-0000-0000-000000000000'::uuid");

                            t.HasCheckConstraint("ck_notification_deliveries_outcome_tuple", "(outcome = 'ACCEPTED' AND acceptance_evidence = 'ACCEPTED' AND acceptance_evidence_reference IS NOT NULL AND btrim(acceptance_evidence_reference) <> '' AND sanitized_error IS NULL) OR (outcome IN ('TRANSIENT_NOT_ACCEPTED', 'PERMANENT_REJECTED', 'ACCEPTANCE_UNKNOWN') AND sanitized_error IS NOT NULL AND btrim(sanitized_error) <> '' AND acceptance_evidence_reference IS NULL)");

                            t.HasCheckConstraint("ck_notification_deliveries_recipient_tuple", "(recipient_user_id IS NOT NULL AND recipient_user_id <> '00000000-0000-0000-0000-000000000000'::uuid AND recipient_key_version IS NULL AND recipient_ciphertext IS NULL) OR (recipient_user_id IS NULL AND recipient_key_version IS NOT NULL AND btrim(recipient_key_version) <> '' AND recipient_ciphertext IS NOT NULL AND octet_length(recipient_ciphertext) > 0)");

                            t.HasCheckConstraint("ck_notification_deliveries_required_text", "btrim(dedupe_key) <> '' AND btrim(channel) <> '' AND btrim(template_identifier) <> '' AND attempt_number > 0");

                            t.HasCheckConstraint("ck_notification_deliveries_time_order", "completed_at >= started_at");
                        });
                });
            ...
            modelBuilder.Entity("DeviceRental.Infrastructure.Persistence.Records.NotificationDeliveryRecord", b =>
                {
                    b.HasOne("DeviceRental.Infrastructure.Persistence.Records.OutboxMessageRecord", null)
                        .WithMany()
